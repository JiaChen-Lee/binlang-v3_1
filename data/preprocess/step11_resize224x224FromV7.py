# Created by Jiachen Li at 2021/2/8 15:30
import cv2
import os
import numpy as np
...
def foo(img_path, dst_img_path):
    ...
    ret = np.zeros((h, h, c), np.uint8)
    ret[:, pad:h - pad, :] = dst
    dst = cv2.resize(ret, (224, 224))
    cv2.imwrite(dst_img_path, dst)


if __name__ == '__main__':
    root = "/home/lijiachen/data/binlang-v2/dataset-v7-rename_*_5/"
    dst_root = "/home/lijiachen/data/binlang-v2/dataset-v11-resize224x224FromV7/"
        ...
        for dataset_name in os.listdir(cls_path):
            ...
            for sub_cls_name in os.listdir(dataset_path):
                ...
                for img_name in os.listdir(sub_cls_path):
                    ...
                    suffix = ".bmp"
                    jpg_name = img_name.split(".")[0] + suffix
